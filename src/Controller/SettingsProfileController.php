...
class SettingsProfileController extends AbstractController
{
    ...
    public function profile(EntityManagerInterface $entityManager, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //Flash messages
            $this->addFlash('success', 'Profile were updated.');
    ...
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    public function profileImage(EntityManagerInterface $entityManager, Request $request, SluggerInterface $sluger): Response
    {
